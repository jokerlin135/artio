...
mixin _$SubscriptionPackage {
  ...
  /// Null if no trial is offered for this package.
  double? get introductoryPrice => throw _privateConstructorUsedError;
...
class _$SubscriptionPackageImpl implements _SubscriptionPackage {
  ...
  @override
  String toString() {
    return 'SubscriptionPackage(identifier: $identifier, priceString: $priceString, price: $price, nativePackage: $nativePackage, introductoryPriceString: $introductoryPriceString, introductoryPrice: $introductoryPrice)';
  }
