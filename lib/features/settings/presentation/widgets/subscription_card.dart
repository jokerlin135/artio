            ...
            return Row(
              children: [
                ...
                FilledButton.tonal(
                  ...
                  // Override global minimumSize(double.infinity) — without this
                  // the button fills the entire Row leaving Expanded 0px wide,
                  // causing text to wrap one character per line (vertical text).
